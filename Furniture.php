  ...
  <section class="shop_section layout_padding">
    <div class="container">
        ...
        <div class="row">
            ...
            // Fetch products for category with ID 2 (Furniture)
            $sql = "SELECT product.*, categories.name AS category_name 
                    FROM product 
                    INNER JOIN categories ON product.category_id = categories.Id 
                    WHERE product.category_id = 2"; // Filter by category ID 2
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    $productId = $row["id"];  // Fetch product ID
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-3">
            ...
            <p>
              Welcome to our Stores Shop, where enchanting tales and heartwarming adventures await your little ones!... 
            </p>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="info_form ">
