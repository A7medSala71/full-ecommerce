  ...
  <section class="shop_section layout_padding">
    <div class="container">
        ...
        <?php
            ...
            $username = "root";
            $password = "";
            $dbname = "ecomerce";  // Corrected database name
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    $productId = $row["id"];  // Make sure you fetch product ID
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 col-lg-4">
            ...
            <p>
              Welcome to our Baby Accessories Shop, where enchanting tales and heartwarming adventures await your little ones!... 
            </p>
          </div>
          <div class="col-md-3 col-lg-4">
            <div class="info_form ">
